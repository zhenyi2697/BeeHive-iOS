...
- (NSArray *)weeklyAaplPrices
{
    ...
    {
        prices = [NSArray arrayWithObjects:
                  [NSDecimalNumber numberWithFloat:371],
                  [NSDecimalNumber numberWithFloat:560],
                  [NSDecimalNumber numberWithFloat:410],
                  [NSDecimalNumber numberWithFloat:207],
                  [NSDecimalNumber numberWithFloat:603],
                  nil];
    }
    return prices;
}
...
- (NSArray *)weeklyGoogPrices
{
    ...
    {
        prices = [NSArray arrayWithObjects:
                  [NSDecimalNumber numberWithFloat:397],
                  [NSDecimalNumber numberWithFloat:501],
                  [NSDecimalNumber numberWithFloat:409],
                  [NSDecimalNumber numberWithFloat:215],
                  [NSDecimalNumber numberWithFloat:454],
                  nil];
    }
    return prices;
}
...
- (NSArray *)weeklyMsftPrices
{
    ...
    if (!prices)
    {
        prices = [NSArray arrayWithObjects:
                  ...
                  [NSDecimalNumber numberWithFloat:31],
                  [NSDecimalNumber numberWithFloat:32],
                  [NSDecimalNumber numberWithFloat:32],
                  [NSDecimalNumber numberWithFloat:31],
                  nil];
